...
const useProps = () => {
  const [props, setProps] = useState({
    ...
    setLang: noop,
    currentLang: "EN",
    macaronPriceUsd: 1.023158668932877668,
    links,
    profile: null,
  });
  ...
  return (
    <BrowserRouter>
      <Menu
        ...
        setLang={noop}
        currentLang="EN"
        macaronPriceUsd={1.23158668932877668}
        links={links}
        profile={{
          profileLink: "/profile",
  ...
  return (
    <BrowserRouter>
      <Menu
        ...
        links={links}
        profile={{
          username: "macaronswap",
          image: "https://macaronswap.finance/images/nfts/blueberries-preview.png",
          profileLink: "/profile",
          noProfileLink: "/no-profile",
        }}
      >
